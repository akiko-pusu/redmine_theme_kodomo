...
LABEL maintainer="AKIKO TAKANO / (Twitter: @akiko_pusu)" \
  description="Image to run Redmine simply with sqlite to try/review plugin & Tea Rose pink theme."
...
RUN git clone https://github.com/akiko-pusu/redmine_theme_kodomo.git public/themes/redmine_theme_kodomo
WORKDIR /app/redmine
...
ENTRYPOINT ["sh", "./public/themes/redmine_theme_kodomo/miscs/docker-entrypoint.sh"]
